...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String Script_Path = "C:\\tpFinalCompiladores\\proyecto_final_compiladores_Definitivo\\compiladores\\src\\main\\java\\compiladores\\symTab.py";
        ...
        System.out.println("Salida de Código Intermedio:\n");
